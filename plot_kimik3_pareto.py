...
mi_fp8n    = load_mi("k3_fp8native_sweep_c{c}", "MI355X fp8 TRITON (native)")
...
mi_bf16    = load_mi("k3_bf16_sweep_c{c}",       "MI355X bf16 gluon (native)")
...
series = {
    ...
    "K3 MI355X (fp8 TRITON, native)": mi_fp8n,
    "K3 MI355X (bf16 ASM, native)": mi_bf16asm,
    "K3 MI355X (bf16 gluon, native)": mi_bf16,
    "K3 B300 (vLLM)":  nv_series("b300"),
    "K3 B200 (dynamo-vLLM)": nv_series("b200"),
}
styles = {
    "K3 MI355X (fp8 ASM, native)": {"color": "#e11d48", "marker": "*", "linestyle": "-"},
    "K3 MI355X (fp8 TRITON, native)": {"color": "#ef4444", "marker": "o", "linestyle": ":"},
    "K3 MI355X (bf16 ASM, native)": {"color": "#a78bfa", "marker": "D", "linestyle": "-"},
    "K3 MI355X (bf16 gluon, native)": {"color": "#f59e0b", "marker": "x", "linestyle": ":"},
    "K3 B300 (vLLM)":  {"color": "#22c55e", "marker": "s", "linestyle": "--"},
